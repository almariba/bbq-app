-- Esquema completo (idempotente) para MVP + task performers
-- Crea tablas si no existen y políticas RLS abiertas para pruebas.
...
-- Limpia políticas previas y re-crea abiertas
...
create policy "menu_all" on public.menu_items for all to anon, authenticated using (true) with check (true);
create policy "selections_all" on public.user_selections for all to anon, authenticated using (true) with check (true);
create policy "tasks_all" on public.tasks for all to anon, authenticated using (true) with check (true);
create policy "task_performers_all" on public.task_performers for all to anon, authenticated using (true) with check (true);
create policy "expenses_all" on public.expenses for all to anon, authenticated using (true) with check (true);

-- SEED menú (idempotente)
